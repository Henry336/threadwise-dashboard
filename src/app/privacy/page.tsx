  ...
  return (
    <main className="privacy-page">
      ...
      <section className="privacy-grid">
        ...
        <article><KeyRound size={21} /><span>02</span><h2>Connected tokens are encrypted</h2><p>OAuth tokens for services such as Gmail, Calendar, or Microsoft are encrypted before they are stored. You can disconnect providers from your settings.</p></article>
