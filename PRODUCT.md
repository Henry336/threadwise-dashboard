...
- Study Overview includes one direct writing entry point. The Study-first full-screen editor keeps portable Markdown canonical while rendering formatting and Mermaid inline, autosaves encrypted drafts across devices, and files completed notes into an existing module-owned Library resource. Personal and Group retain their existing note editors until this Study trial is reviewed.
